        ...
        <section id="contact-us" className="bg-secondary py-16 md:py-24">
            <div className="container">
                <div className="mx-auto max-w-5xl">
                    <div className="card overflow-hidden rounded-lg bg-card text-card-foreground shadow-lg">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p><a href="mailto:admission@egspec.org" className="text-muted-foreground hover:text-primary">admission@egspec.org</a></p>
                                            <p><a href="mailto:enquiry@egspec.org" className="text-muted-foreground hover:text-primary">enquiry@egspec.org</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
